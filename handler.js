...
exports.gradeHand.on('text', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2: return [2 /*return*/, ctx.reply("\u0427\u0442\u043E-\u0442\u043E \u043F\u043E\u0448\u043B\u043E \u043D\u0435 \u0442\u0430\u043A \uD83E\uDD37\u200D\u2642\uFE0F. \u0414\u0430\u0432\u0430\u0439\u0442\u0435 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0435\u043C \u0435\u0449\u0435 \u0440\u0430\u0437\n\n\u0421\u043A\u043E\u043B\u044C\u043A\u043E \u0412\u0430\u043C \u043B\u0435\u0442? (\u0420\u0435\u0431\u0451\u043D\u043A\u0443)")];
        }
    });
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, ctx.wizard.next()];
            case 2:
                if (!(ctx.scene.session.lesson === 'day_myself')) return [3 /*break*/, 4];
            ...
            case 3:
                ...
                return [2 /*return*/, ctx.wizard.next()];
            case 4:
                if (!(ctx.scene.session.lesson === 'day_trainexam')) return [3 /*break*/, 6];
            ...
            case 5:
                ...
                return [2 /*return*/, ctx.wizard.next()];
            case 6:
                if (!!ctx.scene.session.lesson) return [3 /*break*/, 8];
                return [4 /*yield*/, ctx.deleteMessage()];
            case 7:
                _a.sent();
                ctx.reply('Выберите занятие сверху!').then(function (_a) {
...
exports.timeHand.action(/time_.*/, function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(ctx.match[0] === "time_stop")) return [3 /*break*/, 2];
                if (((_a = ctx.scene.session.time) === null || _a === void 0 ? void 0 : _a.length) != 0) {
